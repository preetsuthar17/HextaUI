...
const kbdVariants = cva(
  "inline-flex items-center justify-center font-mono text-xs bg-[hsl(var(--hu-muted))] text-[hsl(var(--hu-muted-foreground))] border border-[hsl(var(--hu-border))] rounded-md border-b-3 transition-all duration-75 cursor-pointer select-none active:translate-y-[1px] active:border-b-[1px]  hover:bg-[hsl(var(--hu-muted))]/80 shadow-md/2",
  {
    variants: {
      variant: {
        default:
