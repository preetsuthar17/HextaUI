                ...
                {!collapsed && (
                  <>
                    <div className="flex flex-col items-start flex-1 min-w-0 overflow-hidden">
                      ...
                      <span className="text-xs text-[hsl(var(--hu-muted-foreground))] truncate">
                        micah@example.com
                      </span>
                    </div>
        ...
        <SidebarHeader>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                <div className="h-6 w-6 rounded-md bg-[hsl(var(--hu-primary))] flex items-center justify-center text-[hsl(var(--hu-primary-foreground))] text-xs font-bold shrink-0">
              ...
              {teams.map((team) => (
                ...
                >
                  <div className="flex items-center gap-2 w-full">
                    <div className="h-6 w-6 rounded bg-[hsl(var(--hu-primary))] flex items-center justify-center text-[hsl(var(--hu-primary-foreground))] text-xs font-bold">
                      {team.name.charAt(0)}
                    </div>
