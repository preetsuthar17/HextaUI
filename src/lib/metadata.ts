...
export function customMetaDataGenerator({
  ...
  const metadataImage = ogImage || "https://hextaui.com/og-image.jpg";

  return {
    title: fullTitle,
    description,
    keywords: keywords.join(", "),
    authors: [{ name: "Preet Suthar" }],
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${fullTitle} - Modern UI Components`,
        },
      ],
    },
    twitter: {
    ...
    category: "technology",
    classification: "UI Components, Web Development, Design System",
    other: {
      "mobile-web-app-capable": "yes",
      "apple-mobile-web-app-capable": "yes",
      "apple-mobile-web-app-status-bar-style": "default",
      "apple-mobile-web-app-title": "HextaUI",
      "application-name": "HextaUI",
