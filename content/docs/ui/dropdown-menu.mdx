...
<div className="my-6 rounded-xl border border-orange-200 bg-orange-50 p-4 dark:border-orange-800 dark:bg-orange-950">
  <div className="flex">
    <div className="ml-3">
      ...
      <div className="mt-2 text-sm text-orange-700 dark:text-orange-300">
        This component requires <code>Kbd</code> component to display keyboard
        shortcuts.
      </div>
    </div>
  </div>
