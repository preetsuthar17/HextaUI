    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "group-[.toast]:bg-[hsl(var(--hu-primary))] group-[.toast]:text-[hsl(var(--hu-primary-foreground))] group-[.toast]:rounded-xl group-[.toast]:px-3 group-[.toast]:py-1.5",
          cancelButton:
            "group-[.toast]:bg-[hsl(var(--hu-accent))] group-[.toast]:text-[hsl(var(--hu-accent-foreground))] group-[.toast]:rounded-xl group-[.toast]:px-3 group-[.toast]:py-1.5",
        },
      }}
      {...props}
    />
