    ...
    return (
      ...
      >
        <div className="animate-pulse p-6">
          {/* Search skeleton */}
          {searchable && (
            <div className="mb-6 h-10 bg-[hsl(var(--hu-muted))] rounded-xl"></div>
          )}
          {/* Table skeleton */}
          ...
          {showPagination && (
            <div className="mt-6 flex justify-between items-center">
              ...
              <div className="flex gap-2">
                <div className="h-9 w-20 bg-[hsl(var(--hu-muted))] rounded-xl"></div>
                <div className="h-9 w-9 bg-[hsl(var(--hu-muted))] rounded-xl"></div>
                <div className="h-9 w-9 bg-[hsl(var(--hu-muted))] rounded-xl"></div>
                <div className="h-9 w-16 bg-[hsl(var(--hu-muted))] rounded-xl"></div>
              </div>
            </div>
          )}
        </div>
