  ...
  <Tab value="Preview">
    <PreviewContainer>
      <Card className="w-full max-w-sm">
        ...
        <CardContent>
          <div className="flex items-center space-x-4 rounded-2xl border border-[hsl(var(--hu-border))] p-4">
    ...
    <PreviewContainer>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-4xl">
        ...
        <Card variant="elevated" className="w-full">
          ...
          <CardContent>
            <p className="text-sm">Elevated card with larger shadow effect.</p>
          </CardContent>
        </Card>
      </div>
    </PreviewContainer>
...
All sub-components accept standard HTML div/heading/paragraph attributes and can be customized with the `className` prop.
...
- Focus management when interactive elements are present
