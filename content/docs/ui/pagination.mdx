...
| ----------- | ------------------------ | ----------- | ------------------------ |
| `variant`   | `"default" \| "compact"` | `"default"` | The visual style variant |
...
| `size`     | `"default" \| "sm" \| "lg"`         | `"default"` | The size of the pagination item      |
| `isActive` | `boolean`                           | `false`     | Whether the item is the current page |
...
| Prop       | Type                        | Default                 | Description                       |
| ---------- | --------------------------- | ----------------------- | --------------------------------- |
| `size`     | `"default" \| "sm" \| "lg"` | `"default"`             | The size of the navigation button |
| `onClick`  | `() => void`                | -                       | Click handler                     |
| `disabled` | `boolean`                   | `false`                 | Whether the button is disabled    |
| `children` | `React.ReactNode`           | `"Previous"` / `"Next"` | Custom label text                 |
