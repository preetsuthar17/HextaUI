    ...
    <PreviewContainer>      <div className="w-full max-w-sm mx-auto">
        <form className="space-y-4">
          ...
          <Button
            type="submit" 
            variant="default"
            className="w-full bg-[hsl(var(--hu-primary))] text-[hsl(var(--hu-primary-foreground))] py-2 px-4 rounded-xl font-medium hover:opacity-90 transition-opacity"
            size="lg"
          >
            Sign In
          </Button>
