...
<Tabs items={["Preview", "Code"]}>
  <Tab value="Preview">
    <PreviewContainer>
      <div className="space-y-4">
        <button
          className="flex items-center gap-2 px-4 py-2 bg-[hsl(var(--hu-primary))] text-primary-foreground rounded-ele hover:bg-[hsl(var(--hu-primary))]/90 transition-colors disabled:opacity-50"
          disabled
        >
