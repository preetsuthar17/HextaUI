  ...
  "inline-flex h-8 w-8 sm:h-9 sm:w-9 items-center justify-center rounded-ele text-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 cursor-pointer",
  {
    variants: {
      variant: {
        ...
        selected:
          "bg-[hsl(var(--hu-primary))] text-primary-foreground hover:bg-[hsl(var(--hu-primary))]/90 focus-visible:ring-ring font-semibold",
        today:
        ...
        "range-start":
          "bg-[hsl(var(--hu-primary))] text-primary-foreground rounded-r-none hover:bg-[hsl(var(--hu-primary))]/90 focus-visible:ring-ring",
        "range-end":
          "bg-[hsl(var(--hu-primary))] text-primary-foreground rounded-l-none hover:bg-[hsl(var(--hu-primary))]/90 focus-visible:ring-ring",
        "range-middle":
          "bg-[hsl(var(--hu-primary))]/20 text-foreground rounded-none hover:bg-[hsl(var(--hu-primary))]/30 focus-visible:ring-ring",
      },
      size: {
