...
const tooltipVariants = cva(
  "z-50 overflow-hidden rounded-lg border border-[hsl(var(--hu-border))] bg-[hsl(var(--hu-card-background))] px-3 py-1.5 text-xs text-[hsl(var(--hu-card-foreground))] shadow-md/2",
  {
    variants: {
      variant: {
        default:
