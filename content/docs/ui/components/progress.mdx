      ...
      <div className="space-y-8 w-full max-w-md">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center text-sm">
            ...
            <span className="text-[hsl(var(--hu-destructive))] text-xs ">
              Error
            </span>
          </div>
      ...
      <div className="space-y-8 w-full max-w-md">
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-[hsl(var(--hu-muted-foreground))] ">7.2 GB of 10 GB</span>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <span className="text-xs text-[hsl(var(--hu-muted-foreground))] ">Downloading...</span>
          </div>
