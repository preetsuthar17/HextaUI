      ...
      return (
        <div className="flex flex-col gap-6">
          ...
          <div className="text-center">
            <button
              className="px-4 py-2 text-sm font-medium bg-[hsl(var(--hu-primary))] text-primary-foreground rounded-md hover:bg-[hsl(var(--hu-primary))]/80 transition-colors disabled:opacity-50"
