...
```tsx title="components/ui/AlertWithIcon.tsx"
"use client";
...
<TypeTable
  type={{
    iconName: {
      description: "Predefined icon name from the available icon set",
      type: '"AlertTriangle" | "CheckCircle" | "Info" | "X" | "AlertCircle" | "Shield" | "Bell" | "Star" | "Zap" | "Heart" | "Settings" | "User" | "Mail" | "Server" | "CreditCard" | "Trophy" | "HardDrive"',
      default: "undefined",
    },
    icon: {
      description: "Custom Lucide icon component to display",
      type: "LucideIcon",
      default: "undefined",
    },
  }}
