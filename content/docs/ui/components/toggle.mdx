...
const toggleVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-ele text-sm transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 shadow-sm/2",
  {
    variants: {
      variant: {
        default:
          "border border-border text-foreground hover:bg-accent hover:text-accent-foreground data-[state=on]:bg-[hsl(var(--hu-primary))] data-[state=on]:text-primary-foreground focus-visible:ring-ring",
        outline:
          "border border-border text-foreground hover:bg-accent hover:text-accent-foreground data-[state=on]:bg-accent data-[state=on]:text-accent-foreground data-[state=on]:border-[hsl(var(--hu-primary))] focus-visible:ring-ring",
        ghost:
        ...
        secondary:
          "bg-secondary text-secondary-foreground hover:bg-secondary/80 data-[state=on]:bg-[hsl(var(--hu-primary))] data-[state=on]:text-primary-foreground focus-visible:ring-ring",
      },
      size: {
