    ...
    <PreviewContainer>
      <Marquee speed="normal" className="py-4">        <div className="flex items-center gap-4">
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=John&backgroundColor=b6e3f4"
              alt="John's avatar"
          ...
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=Sarah&backgroundColor=c084fc"
              alt="Sarah's avatar"
              className="w-12 h-12 rounded-full"
            />
          ...
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=Mike&backgroundColor=86efac"
              alt="Mike's avatar"
              className="w-12 h-12 rounded-full"
            />
          ...
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=Emma&backgroundColor=fbbf24"
              alt="Emma's avatar"
              className="w-12 h-12 rounded-full"
            />
          ...
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=Alex&backgroundColor=fb7185"
              alt="Alex's avatar"
              className="w-12 h-12 rounded-full"
            />
          ...
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=Lisa&backgroundColor=a78bfa"
              alt="Lisa's avatar"
              className="w-12 h-12 rounded-full"
            />
          ...
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=David&backgroundColor=34d399"
              alt="David's avatar"
              className="w-12 h-12 rounded-full"
            />
          ...
          <div className="flex flex-col items-center gap-2">
            <img 
              src="https://api.dicebear.com/7.x/micah/svg?seed=Kate&backgroundColor=60a5fa"
              alt="Kate's avatar"
              className="w-12 h-12 rounded-full"
            />
