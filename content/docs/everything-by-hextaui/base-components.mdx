...
description: A complete set of base components for Next.js projects. Copy, adapt, and personalize them.
icon: Code
---
...
Start by checking out the [Avatar component](/docs/ui/avatar)
