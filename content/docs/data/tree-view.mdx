---
title: Tree View
description: A hierarchical data display component with expand/collapse functionality, perfect for file explorers, organizational charts, or any nested data structure.
new: true
---
...
import {
  TreeView,
  BasicTreeViewDemo,
  CustomIconTreeViewDemo,
  SelectableTreeViewDemo,
} from "@/components/library/data/TreeView";
...
```tsx title="TreeView.tsx" tab="Manually"
"use client";
...
```tsx title="index.tsx"
import { TreeView } from "@/components/library/data/TreeView";
...
<AutoTypeTable
  path="./components/library/data/TreeView.tsx"
  name="TreeViewProps"
/>

### TreeNode

<AutoTypeTable path="./components/library/data/TreeView.tsx" name="TreeNode" />
