---
title: Full Screen SignUp
description: Modern and Beautiful full screen SignUp form with HextaUI
---

import { PreviewContainer } from "@/components/PreviewContainer";
import FullScreenSignup from "@/components/library/marketing/FullScreenSignup";
...
<Callout title="21st.dev" type="info">
  ### This component is available on [21st.dev](https://tinyurl.com/3495nkhx).
</Callout>

## Code

```tsx title="FullScreenSignup.tsx"
"use client";
