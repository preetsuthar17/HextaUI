---
title: Hero for AI Chat Websites
description: Hero component for AI chat websites.
new: true
---
...
![Hero 1](/demos/Hero-1.png)

<Callout title="21st.dev" type="info">
  ### This component is available on [21st.dev](https://tinyurl.com/59859yth).
</Callout>
...
npx shadcn@latest add "https://21st.dev/r/preetsuthar17/hero-1"
```

```tsx title="Hero1.tsx" tab="Manually"
"use client";
