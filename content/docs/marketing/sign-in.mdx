...
import { SignIn4 } from "@/components/library/marketing/SignIn.tsx";
...
npx shadcn@latest add "https://21st.dev/r/preetsuthar17/modern-stunning-sign-in"
```
...
```package-install tab="CLI"
npx shadcn@latest add "https://21st.dev/r/preetsuthar17/clean-minimal-sign-in"
```
