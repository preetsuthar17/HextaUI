...
import { AIChatInput } from "@/components/library/application/AIChatInput";
...
<Callout title="21st.dev" type="info">
  ### This component is available on [21st.dev](https://tinyurl.com/yufuva6x).
</Callout>
...
```tsx title="AIChatInput.tsx" tab="Manually"
"use client";
