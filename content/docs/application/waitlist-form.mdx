---
title: Waitlist Form
description: Animated and minimal waitlist form with email input and submit button.
---

import { WaitlistForm } from "@/components/library/application/WaitlistForm";
...
```tsx title="WaitlistForm.tsx" tab="Manually"
"use client";
...
```tsx title="App.tsx"
import { WaitlistForm } from "@/components/library/WaitlistForm";
