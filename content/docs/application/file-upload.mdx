...
import FileUpload from "@/components/library/application/FileUpload";
...
<Callout title="21st.dev" type="info">
  ### This component is available on [21st.dev](https://tinyurl.com/yjwybrp3).
</Callout>
...
```tsx title="FileUpload.tsx" tab="Manually"
"use client";
