...
- [x] [Calendar](/docs/ui/calendar): A component for displaying a calendar view with date selection.
- [ ] [Color Picker](/docs/ui/color-picker): A component for selecting colors with predefined or custom palettes.
- [x] [Date Picker](/docs/ui/date-picker): A component for selecting single dates or date ranges.
- [x] [Drawer](/docs/ui/drawer): A component for displaying additional content sliding from screen edges.
- [x] [File Upload](/docs/ui/file-upload): A component for selecting and uploading files.
