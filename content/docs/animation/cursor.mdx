...
type MouseTrackerProviderProps = React.ComponentProps<"div"> & {
...
type PointerFollowerProps = HTMLMotionProps<"div"> & {
  align?: Anchor;
  gap?: number;
  ...
  return (
    <div className="max-w-sm rounded-2xl bg-secondary/50 border border-primary/10 shadow-md overflow-hidden relative group">
      ...
      <MouseTrackerProvider>
        <Pointer>
          <MousePointer2 className="fill-blue-600 stroke-white/10" size={30} />
        </Pointer>
        <PointerFollower align="bottom-right">
          <div className="bg-blue-600 text-white border border-white/10 text-xs px-3 py-1 rounded-md shadow-md">
            preett
          </div>
        </PointerFollower>
      </MouseTrackerProvider>
