...
description: Create a writing effect similar to Apple's website using Framer Motion.
new: true
---
...
} from "@/components/library/animation/AppleHelloEffect";
...
```tsx tab="Manually" title="AppleHelloEffect.tsx"
"use client";
...
### Apple Hello Vietnamese

<PreviewContainer>
  <AppleHelloVietnameseEffect className="flex items-center justify-center" />
</PreviewContainer>
...
- [Chánh Đại](https://chanhdai.com/) - Creator of this effect. (Amazing work my friend!)
- Official Apple Hello Lettering, extracted from macOS Sonoma in SVG Form: [official-apple-hello-lettering](https://www.figma.com/community/file/1414773009964314315/official-apple-hello-lettering)
