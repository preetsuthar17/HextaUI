...
export const Feedback = () => {
  ...
  const [feedback, setFeedback] = useState(""); // Add state for textarea
  ...
  const handleSubmit = () => {
    ...
    // Example: Reset feedback and rating after submission
    setFeedback("");
    setRating(0);
      ...
      >
        <div className="w-full">
          <textarea
            ...
            style={{
              filter: feedbackActive ? "blur(0px)" : "blur(10px)",
            }}
        ...
        >
          ...
          <div>
            <Button
              ...
              disabled={!feedbackActive || !feedback}
            >
              Send
            </Button>
          </div>
