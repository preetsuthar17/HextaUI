        ...
        <div className="flex flex-col items-stretch w-full h-full">
          ...
          <div className="flex items-center gap-2 p-3 rounded-full bg-white max-w-3xl w-full">
            ...
            <div className="relative flex-1">
              <input
                ...
                className="flex-1 border-0 outline-0 rounded-md py-2 text-base font-medium bg-transparent w-full"
                ...
                <AnimatePresence mode="wait">
                  {showPlaceholder && !isActive && !inputValue && (
                    <motion.span
                      ...
                      className="absolute left-0 top-1/2 -translate-y-1/2 text-gray-400 select-none pointer-events-none font-medium"
                      style={{
                        whiteSpace: "nowrap",
                        overflow: "hidden",
          ...
          >
            <div className="flex gap-3 items-center">
              ...
              {/* Deep Search Toggle */}
              <motion.button
                className={`flex items-center px-4 gap-1 py-2 rounded-full transition font-medium whitespace-nowrap overflow-hidden justify-start group ${
                  deepSearchActive
                    ? "bg-blue-600/10 outline outline-blue-600/60 text-blue-950"
                    : "bg-gray-100 text-gray-700 hover:bg-gray-200"
                }`}
                ...
                initial={false}
                animate={{
                  width: deepSearchActive ? 125 : 35,
                  paddingLeft: deepSearchActive ? 8 : 8,
                }}
              >
                <div className="flex-1 group-hover:rotate-15 transition ease-in-out">
                  <Globe size={18} />
                </div>
                <motion.span
                  initial={false}
