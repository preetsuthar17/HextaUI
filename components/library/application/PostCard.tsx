  ...
  return (
    <div className="m-4 max-w-[30rem] w-full rounded-2xl border border-primary/10 bg-secondary/50 p-4 text-sm text-secondary-foreground shadow-xs">
      ...
      <div className="mt-4 flex justify-evenly gap-2">
        <button
          onClick={handleLike}
          className="flex grow items-center justify-center gap-3 rounded-md px-4 py-2 transition hover:bg-white/5"
        >
          {liked ? <FaHeart color="red" /> : <FaRegHeart />}
          <span className="hidden opacity-90 text-[14px] transition hover:opacity-100 max-[488px]:inline">
            {liked ? "Liked" : "Like"}
          </span>
        </button>
        ...
        <button className="flex grow items-center justify-center gap-3 rounded-md px-4 py-2 transition hover:bg-white/5">
          <FaRegPaperPlane />
          <span className="hidden opacity-90 text-[14px] transition hover:opacity-100 max-[488px]:inline">
            Share
          </span>
