  ...
  return (
    <>
      <main className="flex flex-1 flex-col justify-center text-center mt-20 gap-5 mb-20 z-0">
        ...
        <section className="border border-primary/10 min-h-[20rem] max-w-[60rem] w-[90%] mx-auto text-left relative overflow-hidden flex items-center justify-center">
          <div className="flex flex-col justify-center gap-4 p-[2rem] max-sm:px-[1rem] z-9999">
            <div className="flex items-center justify-center flex-wrap gap-4 flex-col w-full">
              <div className="flex items-center justify-center flex-wrap gap-2 w-full flex-col">
